# Cycling Markhor — Site Copy (approved, v4 — all seven pages)

Claude Code: these are the words. Use them exactly; ask before rewriting anything.

---

## Global

**Nav labels:** Home · Our Dream · Our Fleet · Our Team · Precious Humans · Where We Ride · Contact
**Footer, all pages:** WhatsApp us · Call us · info@cyclingmarkhor.tours · @cyclingmarkhor.tours · Skardu, Gilgit-Baltistan, Pakistan · © Cycling Markhor
**Links:** WhatsApp `https://wa.me/923554437090` · phone `tel:+923554437090` · email `mailto:info@cyclingmarkhor.tours` · Instagram `https://instagram.com/cyclingmarkhor.tours`
...
### Hero
**Headline:** Ride the roof of the world.
**Subline:** Bike rentals, and soon a mountain cafe, in the heart of Skardu, Baltistan.
**CTA button:** Rent a bike — WhatsApp us

### Status strip
Bike rentals — open now · Mountain cafe & brangsas — coming late 2027
...
**Link under text:** Meet the team →

### The place
**Kicker:** Skardu, in every season
**Heading:** The place
...
- **Our Dream** — The cafe, the brangsas, the villa — drawn in the sand, opening late 2027.
- **Our Fleet** — Fat bikes to gravel bikes: meet the machines.
- **Our Team** — Two founders, two friends, four riders.
- **Precious Humans** — The kids, the cats, the yaks — Baltistan's welcoming committee.
- **Where We Ride** — Turquoise lakes, cold deserts, wooden bridges: the routes we love.
- **Contact** — WhatsApp us. We answer fast. →

### Moments
**Kicker:** From the rides
**Heading:** Moments from the saddle
*(photos speak for themselves — no body text)*
...
**Buttons:** [WhatsApp us] (primary, big) · [Call +92 355 4437090] · [info@cyclingmarkhor.tours] · [@cyclingmarkhor.tours]
...
### Hero
**Headline:** The fleet.
**Subline:** Canyons out front, workhorses behind — a bike for every rider and every road in Baltistan.

### Lead trio
- **Grizl** — Gravel. Built for Baltistan's rough roads.
- **Grail** — Gravel. Fast over the long valley miles.
- **Grand Canyon** — Mountain bike. Happy everywhere else.
...
### Hero
**Headline:** Two friends, one conviction.
**Subline:** And the riders who make every kilometre better.

### Founders
- **Numaan Kashmiri — Co-founder.** An accountant and tax advisor based in Scotland. Cycling Markhor is his dream project — built trip by trip, every time he trades the spreadsheets for the saddle.
- **Hassnain "Hassu" Balti — Co-founder.** President of the Baltistan Cycling Club, and the man who has been renting bikes and guiding riders in Skardu for years. The voice on the other end of our WhatsApp.

### Riders
- **Ejju (Ejaz) — Guide.** A mutual friend and a kind soul. An amazing guide who knows every spring, every shortcut, and every cat along the way.
- **Broko (Ghulam) — Rider.** A mutual friend and a seriously good cyclist. One of our clips is titled "Broko is our hero" — tap his photo and you'll see why.

### Candids strip
**Kicker:** Founders' meetings, Skardu style
*(photos + clip, no body text)*

### Mosaic
**Kicker:** Better together
*(curated grid, no body text)*

---

## our-precious-humans.html — Precious Humans

### Hero
**Headline:** Our precious humans.
**Subline:** Bikes brought us here. These are the ones who make us stay.

### The kids
**Heading:** The welcoming committee
Ride through Shigar and Kharmang and you arrive alone but leave with an escort. The kids of these villages are our loudest cheering section, our most honest critics, and — whenever the Prado is parked — our keenest passengers. Up in the hero, that's M Hassan streamside with Ejju — and Arsalan, sitting out a frozen slope like it was summer.
...
*(no further text; media carries this section)*
...
## our-dream.html — Our Dream

### Hero
**Headline:** From a dream, to lines in the sand.
**Subline:** The mountain cafe, the brangsas, the villa — coming late 2027.
...
### Winter block
**Heading:** We know this land in winter
...
- **Next** — First cutting on the land
- **Late 2027** — Mountain cafe, brangsas & villa open

### CTA
Follow the build: **[@cyclingmarkhor.tours]** · **[WhatsApp us]**

---

## Page titles + meta descriptions (SEO)

- **Home:** `Cycling Markhor — Bike rentals in Skardu, Baltistan` / "Ride the roof of the world. Bike rentals, and soon a mountain cafe, in the heart of Skardu, Baltistan."
- **Our Dream:** `Our Dream — Cycling Markhor` / "A mountain cafe, traditional brangsas and a villa above Skardu — drawn in the sand, opening late 2027."
...
- "**brangsas**" and "**brangsa**" are intentional and correct — traditional Balti rooms. Do not "correct" them.
- "**broq**" (lowercase) = the high summer pasture above a Balti village — cultural term, fine to use. **Never** name any guesthouse or resort in copy or alt text.
- Name spellings are exact: **Numaan Kashmiri**, **Hassnain "Hassu" Balti**, **Ejju (Ejaz)**, **Broko (Ghulam)**, **M Hassan**, **Arsalan**.
- No prices, no sizes, no booking promises anywhere — WhatsApp is the answer to all of it.
- The "Moments of stillness" section: exactly the copy given, nothing added, autoplay off.
- Keep all copy exactly as written unless Nauman asks for changes.
