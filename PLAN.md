...
- **Standing rules (media rows):** Media grids centre their rows. Never mix portrait and landscape clips in one grid. A section with fewer than three clips does not use a grid layout. One portrait alongside several landscape clips uses the split layout, not its own row. Section headings are derived from the footage on that page, not from a shared template — "from the sky" means aerial.
...
- **Valley page template:** hero (ambient clip or hero-tier photo) → intro → media rows with kickers, then "From the roadside" (contain-on-blur slideshow). Kickers are page-specific (see per-page maps) — "From the handlebars" only over true POV, "From the sky" only over aerial footage. All clips muted, autoplay-in-viewport, `preload="none"`.
- **rides/kharmang-valley.html** (richest): hero `khamosh-waterfall` ambient · "From the handlebars" `pov-crossing-bridge`, `pov-ducks`, `pov-frozen-river` · "From the sky" (true aerials) `broko-and-chocolate-rocks`, `broko-is-our-hero`, `bridge-reverse` · "On the valley roads" — pair `exiting-gol` + `labayak-ya-hussain`, portrait row `cat-near-khamosh-waterfall`, `ejju-and-nauman-petting-cat-near-khamosh-waterfall`, `ejju-nauman-broko` · roadside `nauman-ejju-and-broko-1`, `-2`, `prado-with-river-and-mountains-in-the-background-1`, `-2`.
- **rides/shigar-valley.html:** hero `shigar` ambient · "From the handlebars" `pov-into-shigar`, `pov-more-ducks`, `pov-sheep`, `pov-towards-sildi` · "Across the valley" (ground-level follow-cams, split layout) — portrait `yaks-in-shigar` beside stacked `sarfaranga-climb`, `sarfaranga-desert`, `cycling-towards-gulabpur` · roadside `broko-nauman-and-ejju-climbing-to-shigar`, `nauman-and-ejju-dangerous-river-crossing`, `nauman-in-shigar`, `nauman-in-shigar-with-kids`, `yak-attack`, `nauman-with-sarfaranga-in-background`, `ejju-1`, `broko` · BLIND LAKE (JARBA TSO) section: existing blurb, ambient `blind-lake`+`blind-lake-reverse`, clips `gravel-near-blind-lake` + `nauman-and-ejju-cycling-towards-blind-lake`, photos `nauman-and-ejju-gravel-ride-to-blind-lake` + `surviving-sub-zero`.
- **rides/upper-kachura.html** (compact): hero `riding-towards-kachura` ambient · "The ride in" — `nauman-hassnain-ejju-broko-cycling-towards-kachura` (vehicle-shot, not aerial) large and centred, `hassnain-going-down-stairs-to-upper-kachura-lake` phone-frame directly beneath · roadside `hassnain-loading-bicycle-in-upper-kachura` single photo, natural aspect.
- **rides/ghundus-valley.html:** hero `nauman-ejju-and-broko-in-ghundus-valley` photo with hero tier (1280/1600/2560 srcset) · "From the handlebars" `hassnain-pov-crossing-tractor` · "From the sky" (true aerials) `hassnain-crossing-bridge`, `lake-reverse` · roadside `broko-ejju-prado-and-nauman`, `broko-in-ghundus`, `le-ejju-and-broko`, `ejju-2`, `ejju-and-m-hassan`, `ejju-in-prostration-1`, `grizl-and-grail`, `nauman-and-ejju`, `nauman-in-ghundus`, `nauman-and-kids-1`.
- **rides/hussainabad-broq.html:** hero `view-from-broq` ambient · "The way up" (no aerial footage exists — split layout): portrait `ejju-and-hassnain-going-up-masrur` beside stacked `hassnain-climbing-masrur-rock` + `hassnain-broq-stairs-2` (`hassnain-broq-stairs-1` cut — near-duplicate of `-2`; guesthouse visible-but-unnamed confirmed intended) · roadside `ejju-headed-to-masrur-rock`, `hassnain-arsalan-and-broko`, `night-view-from-broq`, `cycling-markhor`, `cycling-markhor-cafe-side-logo`, `cycling-markhor-cafe-back-logo`.
